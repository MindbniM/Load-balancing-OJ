...
DEFINE_string(instance_name, "/compile_service/instance", "当前实例名称");
DEFINE_string(access_host, "0.0.0.0:10001", "当前实例的外部访问地址");
...
int main(int argc,char* argv[])
{
    ...
    CompileServer::ptr server=sb.newCompileServer();
    server->start();
    return 0;
}